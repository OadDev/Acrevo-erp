<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Completed Sites" subtitle="Project history, completion certificates, and client feedback." />
    </x-slot>

    <x-card :padded="false">
        @if ($workOrders->isEmpty())
            <div class="p-6">
                <x-empty-state icon="check-circle" title="Nothing completed yet" />
            </div>
        @else
