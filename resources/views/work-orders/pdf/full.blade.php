...
<body>
    ...
    <p class="muted">{{ $workOrder->site?->site_no ? $workOrder->site->site_no.' &middot; ' : '' }}{{ $workOrder->client?->name }} &middot; Generated {{ now()->timezone('Asia/Kolkata')->format('d M Y, h:i A') }}</p>
