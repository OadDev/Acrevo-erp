<x-app-layout>
    ...
    <x-card class="max-w-5xl">
        <form method="POST" action="{{ route('work-orders.store') }}" x-data="{
            ...
            materials: @js(old('materials', [['material_name' => '', 'brand' => '', 'size' => '', 'unit' => 'Nos', 'quantity' => '', 'rate' => '', 'vendor' => '']])),
            labour: @js(old('labour', [['labour_type' => '', 'count' => 1, 'hours' => '', 'wage_rate' => '']])),
            equipment: @js(old('equipment', [['item_name' => '', 'unit' => 'Nos', 'quantity' => '', 'rate' => '', 'vendor' => '']])),
            transport: @js(old('transport', [['item_name' => '', 'unit' => 'Trip', 'quantity' => '', 'rate' => '', 'vendor' => '']])),
            misc: @js(old('misc', [['item_name' => '', 'unit' => 'Nos', 'quantity' => '', 'rate' => '', 'vendor' => '']])),
            procedures: @js(old('procedures', [['item_description' => '', 'length' => '', 'breadth' => '', 'height' => '', 'quantity' => '', 'unit' => 'Sqft']])),
            timeSchedules: @js(old('time_schedules', [['time_to_finish' => '', 'unit' => '', 'remark' => '']])),
