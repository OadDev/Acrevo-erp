...
<x-card :padded="false" x-data="{ editAttendance: null }">
    <div class="p-4">
        ...
        <p class="mt-1 text-xs text-gray-400">Kept separate from the Measurement Book, full width, so there's enough room to enter and review attendance details.</p>
    </div>

    <form method="GET" action="{{ route('work-orders.show', $workOrder) }}#attendance" class="grid grid-cols-2 gap-2 border-t border-gray-100 p-4 dark:border-gray-800 sm:grid-cols-5">
