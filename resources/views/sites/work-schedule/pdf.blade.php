...
<body>
    ...
    @else
        <table>
            <thead>
                <tr>
                    <th>S.No</th><th>Work</th><th>Day</th><th>Date</th><th class="text-right">Duration</th>
                    <th>Original End</th><th>Revised End</th><th class="text-right">Variance</th>
            ...
            <tbody>
                @foreach ($schedules as $schedule)
                    ...
                    <tr>
                        ...
                        <td class="text-right">{{ $variance > 0 ? '+'.$variance : $variance }}d</td>
