...
>
    <div class="flex h-16 items-center gap-2 border-b border-gray-200 px-5 dark:border-gray-800">
        <div class="flex h-8 w-8 items-center justify-center rounded-lg bg-indigo-600 text-sm font-bold text-white">OX</div>
        <span class="text-lg font-semibold tracking-tight text-gray-900 dark:text-white">OrbitX ERP</span>
    </div>
