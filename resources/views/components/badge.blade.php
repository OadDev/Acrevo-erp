...
@php
    $palette = match (true) {
        ...
        in_array($status, ['qc_failed', 'ticket_raised', 'rework_in_progress', 'failed', 'rejected', 'cancelled', 'overdue', 'lost', 'absent', 'critical', 'high', 'urgent', 'damaged', 'missing', 'expired']) => 'rose',
        default => 'gray',
    };
